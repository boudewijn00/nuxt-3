...
import { RouterLink } from 'vue-router';
    ...
    const items = [
        ...
        { label: 'steps', icon: 'pi pi-fw pi-map'},
        { label: 'upload', icon: 'pi pi-fw pi-upload', to: '/upload'},
        { label: 'divider', icon: 'pi pi-fw pi-list', to: '/divider'},
        { label: 'data view', icon: 'pi pi-fw pi-database', to: '/data-view'}
    ];
</script>